...
function PracticeFind(props) {
    const { object1 ,ball, object2 ,text1 , text2 , clickHandler ,objectG1,objectG2 , audio1 ,audio2 ,page} = props; 
        ...
        <div className="session-main">
            ...
            <div className="session-main-list">
                <div className=" list-item list-img"> 
                    <div className="imga imgTeacher"><img src={image1}  onClick={(e) => {
                    setImage1(objectG1)
					clickHandler(e, {
                 ...
                 {text1 && <div className="text textTeacher">
