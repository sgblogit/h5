...
function ConversationTK(props) {
    const { object1 , object2 ,text1 , text2 , clickHandler ,objectG1,objectG2 , audio1 ,audio2 ,page ,reverseObj} = props; 
    ...
    return (
        <div className="session-main">
            <div className="session-main-list">
                ...
                <div className= {` list-item main-content  ${reverseObj ? reverseObj : ""} `}>
                    {text1 && <div className=
                         {` text textTeacher  ${textT1 ? textT1 : ""}  `}
                    >
                        <img src={text1} alt=""></img>
                    </div>}
                    <div className=
                        {` text textKid  ${textT2 ? textT2 : ""}  `}
                    >
